 ...
 */
const a=new WeakMap,o=Object(s.e)(e=>t=>{if(!(t instanceof s.b))throw new Error("unsafeHTML can only be used in text bindings");const n=a.get(t);if(void 0!==n&&Object(i.h)(e)&&e===n.value&&t.value===n.fragment)return;const o=document.createElement("template");o.innerHTML=e;const r=document.importNode(o.content,!0);t.setValue(r),a.set(t,{value:e,fragment:r})})},768:function(e,t,n){"use strict";n.r(t),n.d(t,"Imodal",(function(){return c}));n(13),n(16),n(10);var i=n(1),s=n(370),a=(n(399),n(21)),o=n(174),r=function(e,t,n,i){var s,a=arguments.length,o=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,n):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,n,i);else for(var r=e.length-1;r>=0;r--)(s=e[r])&&(o=(a<3?s(o):a>3?s(t,n,o):s(t,n))||o);return a>3&&o&&Object.defineProperty(t,n,o),o};let c=class extends i.a{constructor(){super(...arguments),this.step="loading"}showError(){this.step="error"}async reUpdate(){localStorage.removeItem("user-checkout-old-data"),localStorage.setItem("bg-updating",""+Date.now()),o.slave.sendMessage("tabs-reload"),a.a.send({key:"bg-update",data:"9.9.9"}),setTimeout(()=>{location.reload()},0)}async showRepair(){if(this.step=null,document.querySelector("i-updating").classList.add("hide"),localStorage.setItem("user-checkout-old-data","true"),localStorage.getItem("updating-manual"))return;const{pluginStore:e}=await Promise.all([n.e(2),n.e(37)]).then(n.bind(null,365));e.showRepair()}render(){return"loading"===this.step?i.e`
