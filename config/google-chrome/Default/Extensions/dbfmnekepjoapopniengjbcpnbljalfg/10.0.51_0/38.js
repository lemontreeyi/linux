        ...
        <div class="global-scrollbar main-body">
          ${e&&e.length?o.e`
              ...
              `:o.e`
                <div class="empty">
                  <img .src=${p.a} />
                  <p>${i18n("no_chrome_app",d.B.vendor)}</p>
                </div>
              `}
        </div>
      </div>
